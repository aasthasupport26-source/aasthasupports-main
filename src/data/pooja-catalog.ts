...
export const STANDARD_PUJA_PACKAGES: PackageTier[] = [
  ...
  {
    id: "pkg-group-501",
    name: "Group Puja — Individual (समूह पूजा)",
    price: 501,
    description: "₹501 प्रति व्यक्ति — नाम एवं गोत्र से संकल्प, समूह पूजा में सहभागिता।",
    includes: ["नाम एवं गोत्र संकल्प", "समूह पूजा में सहभागिता", "संकल्प फोटो"],
    photo: true,
    video: false,
    live_call: false,
    prasad: false,
  ...
  {
    id: "pkg-group-1100",
    name: "Group Puja — Family (समूह पूजा 5 सदस्य)",
    price: 1100,
    description: "₹1100 अधिकतम 5 परिवार के सदस्य — नाम एवं गोत्र से संकल्प, समूह पूजा में सहभागिता।",
    includes: ["5 परिवार सदस्यों का नाम व गोत्र संकल्प", "समूह पूजा सहभागिता", "पूजा फोटो"],
    photo: true,
    video: false,
    live_call: false,
    prasad: false,
  ...
  {
    id: "pkg-personal-2100",
    name: "Personalized Puja (व्यक्तिगत पूजा)",
    price: 2100,
    description: "केवल आपके परिवार के लिए समर्पित व्यक्तिगत पूजा। नाम एवं गोत्र से संकल्प, वीडियो रिकॉर्डिंग, प्रसाद आपके पते पर।",
    includes: ["समर्पित व्यक्तिगत पूजा", "परिवार नाम व गोत्र संकल्प", "HD वीडियो रिकॉर्डिंग", "पवित्र प्रसाद आपके घर पते पर"],
    photo: true,
    video: true,
    live_call: false,
    prasad: true,
  ...
  },
  {
    ...
    price: 5100,
    description: "केवल आपके लिए समर्पित व्यक्तिगत पूजा, पंडित जी के साथ Live Video Call / Conference, व्यक्तिगत संकल्प, HD वीडियो रिकॉर्डिंग, प्रसाद आपके पते पर, प्राथमिक (Priority) सहायता।",
    includes: [
      "पंडित जी के साथ Live Video Call / Zoom Conference",
      "समर्पित व्यक्तिगत संकल्प",
      "HD वीडियो रिकॉर्डिंग व फोटो",
      "पवित्र प्रसाद आपके घर पते पर",
      "Priority VIP सहायता एवं सहायता प्रबंधक",
    ],
    photo: true,
    video: true,
    live_call: true,
