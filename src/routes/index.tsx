...
// Testimonials hidden until authentic customer reviews are collected (re-enable when real reviews arrive)
const testimonials = [
  {
    name: "Rakesh Sharma",
    city: "Mumbai",
...
function HomePage() {
  return (
    <Layout>
      ...
      {/* Testimonials - Hidden per audit until authentic customer reviews are collected */}
      {false && (
