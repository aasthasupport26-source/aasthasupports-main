...
export const Route = createFileRoute("/order-success/$orderNumber")({
  head: () => ({
    meta: [{ title: "Order Confirmed — Aastha Support" }, { name: "robots", content: "noindex" }],
  }),
    ...
    <Layout>
      <div className="container mx-auto px-4 py-20 max-w-2xl text-center">
          ...
          <div className="p-4 rounded-lg bg-cream border border-gold/20 flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Pandits will perform sankalp & energise your items.
              </p>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-cream border border-gold/20 flex gap-3">
        ...
        <div className="mt-8 flex gap-3 justify-center flex-wrap">
          <Link
            to="/track-order"
            className="bg-royal text-cream px-6 py-3 rounded-md text-xs tracking-widest uppercase hover:opacity-90 shadow-royal"
          >
            Track Order
          </Link>
          <Link
            to="/shop"
            className="border border-maroon text-maroon px-6 py-3 rounded-md text-xs tracking-widest uppercase hover:bg-maroon hover:text-cream transition"
          >
            Continue Shopping
          </Link>
        </div>
